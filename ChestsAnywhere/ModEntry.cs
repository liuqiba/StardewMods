        ...
        private void ChangeOverlayIfNeeded()
        {
            ...
            switch (menu)
            {
                case ItemGrabMenu chestMenu:
                    this.CurrentOverlay = new ChestOverlay(chestMenu, chest, chests, this.Config, this.Keys, this.Helper.Events, this.Helper.Input, this.Helper.Reflection, this.Helper.Translation, showAutomateOptions: isAutomateInstalled && chest.CanConfigureAutomate,this.Monitor);
                    break;

                case ShopMenu shopMenu:
                    this.CurrentOverlay = new ShopMenuOverlay(shopMenu, chest, chests, this.Config, this.Keys, this.Helper.Events, this.Helper.Input, this.Helper.Reflection, this.Helper.Translation, showAutomateOptions: isAutomateInstalled && chest.CanConfigureAutomate,this.Monitor);
                    break;
            }
